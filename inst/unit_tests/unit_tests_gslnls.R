...
misra1a_fit23 <- with(misra1a, gsl_nls(fn = fn, data = data, start = list(b1 = c(200, 250), b2 = 1e-4), loss = "hampel", trace = TRUE))
...
misra1a_fit25 <- with(misra1a, gsl_nls(fn = fn, data = data, start = list(b1 = NA, b2 = 1e-4), loss = "ggw"))
